      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 border rounded p-4 space-y-1">
            <div className="flex justify-between items-center">
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">Tom McBride</span>
                  <span className="text-xs bg-blue-100 text-blue-600 px-2 py-0.5 rounded">Primary</span>
                </div>
                <p className="text-sm text-gray-500">**** **** 9856</p>
              </div>
            ...
            <p className="text-xs text-gray-500">Card expires at 12/26</p>
          </div>
          ...
          <div className="bg-gray-50 border rounded p-4 space-y-1">
            <div className="flex justify-between items-center">
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium">Mildred Wagner</span>
                </div>
                <p className="text-sm text-gray-500">**** **** 5896</p>
              </div>
              <div className="space-x-2">
                <button className="bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded hover:bg-gray-200">Edit</button>
                <button className="bg-red-100 text-red-500 text-xs px-3 py-1 rounded hover:bg-red-200">Delete</button>
            ...
            <p className="text-xs text-gray-500">Card expires at 10/27</p>
          </div>
        </div>
